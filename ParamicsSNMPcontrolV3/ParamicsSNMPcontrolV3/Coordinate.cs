...
namespace ParamincsSNMPcontrol
{
    public class Coordinate
    {
        ...
        //function
        public virtual int[] EvaluationProcess(int ModelTimeofDay)
        {
            ...
            MainZone.CoordinateJunctions(ModelTimeofDay);
    ...
    public class coordinateSIT : Coordinate
    {
        ...
        //function
        public override int[] EvaluationProcess(int ModelTimeofDay)
        {
            TimeSpan TS = new TimeSpan(0, 0, ModelTimeofDay / 100);
            string TimeOfDay = TS.ToString();
