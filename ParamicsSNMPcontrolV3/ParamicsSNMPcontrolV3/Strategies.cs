...
namespace ParamincsSNMPcontrol
{
    ...
    public abstract class Strategies
    {
        ...
        public abstract void ProcessJunction(JunctionAgent JA);
        public abstract void ProcessZone(ZoneAgent ZA,int ToD);
    ...
    public class BasicStrategy : Strategies
    {
        ...
        public override void ProcessJunction(JunctionAgent JA)
        {
            ...
            //This is for the four stage model
            ...
            //This is for the two stage model
    ...
    public class MultiHighBid : HighBid             //AH Thinks that this is for the two T-junction game - 04/12/13
    {
        double
            Distance,
            G1,
